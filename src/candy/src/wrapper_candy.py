...
class CarlaGame(object):
    def __init__(self, carla_wrapper, image_getter, speed_getter, steer_getter, brake_throttle_getter, is_auto_getter, throttle_publisher, steer_publisher, train=False):
        self._timer = None
        self._display = None
    ...
    def _on_loop(self):
        ...
        self.cnt += 1
        model_control = self.carla_wrapper.get_control_and_update([self._main_image, control, reward, control, manual, speed])
...
if __name__ == '__main__':
    ...
    carla_game = CarlaGame(carla_wrapper, wrapper_candy.image_getter(), wrapper_candy.speed_getter(), wrapper_candy.steer_getter(), wrapper_candy.brake_throttle_getter(), wrapper_candy.is_auto_getter(), wrapper_candy.throttle_publisher, wrapper_candy.steer_publisher, args.train)
